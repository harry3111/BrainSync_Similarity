...
outdir = [outputpath 'Sim_Demo_PartialCorr_Results_' sim_str '_CORRECTED/'];  %%!!    %%!!  
if ~exist(outdir, 'dir')
    mkdir(outdir);
end
...
cov_strs = {'infant_sex_male', 'birthweight_grams', 'gestAge_birth_days', 'gestAge_scan_days', 'meanFDs_Infant_truepair', 'meanFDs_MOC_truepair'};  %%!!  
cov_sstrs = {'infant-sex-male', 'birthweight-grams', 'gestAge-birth-days', 'gestAge-scan-days', 'meanFDs-Infant-truepair', 'meanFDs-MOC-truepair'};  %%!!  
...
for dd = 1:length(demo_strs)
    ...
    if ~(exist(outfile1, 'file') && exist(outfile2, 'file'))
        ...
        save(outfile1, 'sim_str', 'sim_sstr', 'cov_strs', 'cov_sstrs', 'demo_str', 'demo_sstr', 'Sim', 'Demo', 'ind_valDemo', 'valSim', 'valDemo', 'valCovs', 'group_1', 'group_2', 'subjects_matched_1', 'subjects_matched_2', 'valsubjects_matched_1', 'valsubjects_matched_2', 'valPartialCorr', 'valP', 'perm_valDemos', 'perm_valPartialCorrs', 'valPermP'); % 
...
save([outdir 'Ps_FDR_H_Results_' sim_str '.mat'], 'alpha', 'valPs_FDR', 'valPs_FDR_H', 'valPermPs_FDR', 'valPermPs_FDR_H', 'valPs', 'valPs_H', 'valPermPs', 'valPermPs_H', 'cov_strs', 'demo_strs'); %% 
